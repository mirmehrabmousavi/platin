<!DOCTYPE html>
<!--[if lt IE 7]>
<html class="lt-ie9 lt-ie8 lt-ie7" lang="fa"> <![endif]-->
<!--[if IE 7]>
<html class="lt-ie9 lt-ie8" lang="fa"> <![endif]-->
<!--[if IE 8]>
<html class="lt-ie9" lang="fa"> <![endif]-->
<!--[if gt IE 8]><!-->
<html lang="fa"> <!--<![endif]-->
<head>
...
<div class="login"> <!-- Login -->
    ...
    <form class="form" id="forms" action="{{route('submitReg')}}" method="POST">
        ...
        <p class="field" id="1">
            ...
            <input type="text" name="lname" id="lname" value="" Alt="">
        </p>
        <p class="field" id="1">
            <label for="phone"><span>Phone no. :</span></label>
            <input type="text" name="phone" id="phone" value="" Alt="">
        </p>
        <p class="field" id="1">
            <label for="country"><span>Country:&nbsp;&nbsp;&nbsp;&nbsp;</span></label>
            <select id="country" name="country" style="width: 225px; font-family: sans-serif;">
        ...
        <p class="field" id="1">
            <label for="license"><span>Serial no. :</span></label>
            <input type="text" name="productcode" id="license" value="" Alt="123456">
        </p>
